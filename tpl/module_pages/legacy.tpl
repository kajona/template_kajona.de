...
<div class="home-banner-container default-banner-container">
    <div class="container">
        <div class="row banner-top-row">
            ...
            <a class="social hidden-sm-down" href="https://www.facebook.com/Kajona-156841314360532/"><i class="fa fa-facebook" aria-hidden="true"></i></a>
...
<div class="container body-container default-body">

    <div class="container">

       <div class="row main-container-wrapper">

                <div class="col-lg-9 col-xs-12 main-container">


                    %%headline_row%%
                    %%text_paragraph%%
                    %%picture1_image%%
                    %%mixedcontent_image|paragraph|sourcecode%%
                    %%news_news%%
                    %%gb1_guestbook%%
                    %%dl1_downloads%%
                    %%bilder_gallery%%
                    ...
                    %%liste_faqs%%
                    %%sitemap_navigation%%
                    %%files_directorybrowser%%
                    %%redirect_languageredirect%%
                    %%mixed2_markdown|paragraph%%
            ...
            <div class="col-lg-3 hidden-md-down navi-container">
            <hr />
...
<div class="container footer-container">
    ...
    <div class="row">
        ...
        <div class="col-md-6 commercial">
            <a style="background:url(_webpath_/templates/kajondev5/pics/footer_icon-paypal.png);" href="_webpath_/donate.html"></a>
            <a style="background:url(_webpath_/templates/kajondev5/pics/footer_icon-ohloh.png);" href="https://www.openhub.net/p/kajona"></a>
            <a style="background:url(_webpath_/templates/kajondev5/pics/footer_icon-facebook.png);" href="http://www.facebook.com/pages/Kajona%C2%B3/156841314360532"></a>
